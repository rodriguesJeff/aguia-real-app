            ...
            Row(
              ...
              children: [
                const CircleAvatar(
                  ...
                  backgroundImage: NetworkImage('https://avatars.githubusercontent.com/u/32440959?s=40&v=4'),
                ),
                Column(
                  children: const [
                    Text(
              ...
              child: ExpansionTile(
                ...
                children: [
                  Container(
                    ...
                    alignment: Alignment.topLeft,
                    child:
                        const Text('Hard Skills', style: TextStyle(fontSize: 20.0)),
                  ),
                  const ListTile(
                  ...
                  Container(
                    ...
                    alignment: Alignment.topLeft,
                    child:
                        const Text('Soft Skills', style: TextStyle(fontSize: 20.0)),
                  ),
                  const ListTile(
                  ...
                  Container(
                    ...
                    alignment: Alignment.topLeft,
                    child:
                        const Text('Sessões de brainstorming', style: TextStyle(fontSize: 20.0)),
                  ),
                  const ListTile(
