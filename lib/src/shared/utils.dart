...
class Utils {
  static Color primaryColor = const Color(0xff135DA6);
  static Color darkBlue = const Color(0xff164F84);
  static Color yellowPrimary = const Color(0xffF6C514);
  static Color greyLight = const Color(0xffF2F2F2);
  static Color greyMid = const Color(0xff888888);
